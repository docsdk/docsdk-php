...
class TaskResourceTest extends TestCase
{
    ...
    public function testGet()
    {
        ...
        $task = $this->docSDK->tasks()->get('4c80f1ae-5b3a-43d5-bb58-1a5c4eb4e46b');
    ...
    public function testRefresh()
    {
        ...
        $this->docSDK->tasks()->refresh($task);
    ...
    public function testUploadFile()
    {
        ...
        $response = $this->docSDK->tasks()->upload($task, "filecontent");
