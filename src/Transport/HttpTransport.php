...
namespace DocSDK\Transport;


use DocSDK\Exceptions\HttpClientException;
use DocSDK\Exceptions\HttpServerException;
...
class HttpTransport
{
    ...
    protected function createHttpClientInstance(): HttpClient
    {
        ...
        $httpClientPlugins = [
            new HeaderDefaultsPlugin([
                'User-Agent' => 'docsdk-php/v3 (https://github.com/docsdk/docsdk-php)',
            ]),
            new RedirectPlugin()
        ];
    ...
    {
        return $this->options['sandbox'] ? 'https://api.sandbox.docsdk.com/v2' : 'https://api.docsdk.com/v2';
    }
     ...
     * @throws \DocSDK\Exceptions\Exception
     */
